...
import com.example.socialcompass.Activities.MainActivity;
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.InputUId),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("11111111111111111111111111111111"), closeSoftKeyboard());
